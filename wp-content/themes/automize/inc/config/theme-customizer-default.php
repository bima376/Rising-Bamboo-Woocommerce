...
$cz_body_font_family = $cz_heading_font_family = 'Bai Jamjuree';
$cz_body_text        = '#666666';
$cz_primary_color    = '#000000';
$cz_secondary_color  = '#db0000';
...
return [
	...
	RISING_BAMBOO_KIRKI_FIELD_WOOCOMMERCE_MINI_CART_ICON => [
		'default' => 'rbb-icon-shopping-cart-6',
	],
	...
	RISING_BAMBOO_KIRKI_FIELD_WOOCOMMERCE_PRODUCT_DETAIL_SUMMARY_GUARANTEE_CHECKOUT_TEXT => [
		'default' => __('Guarantee safe & secure checkout', 'automize'),
	],
	...
	RISING_BAMBOO_KIRKI_FIELD_WOOCOMMERCE_PRODUCT_DETAIL_SUMMARY_CONTACT_TEXT => [
		'default' => __('Ask a Question', 'automize'),
	],
	...
	RISING_BAMBOO_KIRKI_SECTION_WOOCOMMERCE_PRODUCT_CATALOG_PRODUCT_ITEM_SHOW_CATEGORY => [
		'default' => true,
	],
	// </editor-fold>
