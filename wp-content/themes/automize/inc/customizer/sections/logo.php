...
RisingBambooKirki::add_section(
	...
	[
		'title'          => esc_html__('Logo', 'automize'),
		'description'    => esc_html__('This section contains general logo options.', 'automize'),
	]
);
...
RisingBambooKirki::add_field(
	...
	[
		...
		'description' => esc_html__('Show/Hide the logo ?', 'automize'),
		'section'     => RISING_BAMBOO_KIRKI_SECTION_LOGO,
...
RisingBambooKirki::add_field(
	...
	[
		...
		'label'           => esc_html__('Default Logo', 'automize'),
		'description'     => esc_html__('Choose default logo.', 'automize'),
		'section'         => RISING_BAMBOO_KIRKI_SECTION_LOGO,
		'default'         => Helper::get_default(RISING_BAMBOO_KIRKI_FIELD_LOGO_MODE),
		'priority'        => $priority++,
		'choices'         => [
			'dark'  => esc_html__('Dark Logo', 'automize'),
			'light' => esc_html__('Light Logo', 'automize'),
		],
		'active_callback' => [
			[
...
RisingBambooKirki::add_field(
	...
	[
		...
		'label'           => esc_html__('Dark Version', 'automize'),
		'section'         => RISING_BAMBOO_KIRKI_SECTION_LOGO,
...
RisingBambooKirki::add_field(
	...
	[
		...
		'label'           => esc_html__('Light Version', 'automize'),
		'section'         => RISING_BAMBOO_KIRKI_SECTION_LOGO,
...
RisingBambooKirki::add_field(
	...
	[
		...
		'label'           => esc_html__('Logo Max Width', 'automize'),
		'section'         => RISING_BAMBOO_KIRKI_SECTION_LOGO,
...
RisingBambooKirki::add_field(
	...
	[
		...
		'label'           => esc_html__('Logo Padding', 'automize'),
		'description'     => esc_html__('For e.g: 1em 10rem 1vh 10px', 'automize'),
		'section'         => RISING_BAMBOO_KIRKI_SECTION_LOGO,
...
RisingBambooKirki::add_field(
	...
	[
		...
		'section'         => RISING_BAMBOO_KIRKI_SECTION_LOGO,
		'priority'        => $priority++,
		'default'         => '<div class="rising-bamboo-kirki-separator">' . esc_html__('Sticky', 'automize') . '</div>',
		'active_callback' => [
			[
				'setting'  => RISING_BAMBOO_KIRKI_FIELD_LOGO_STATUS,
				'operator' => '==',
