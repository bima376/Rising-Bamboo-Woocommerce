...
RisingBambooKirki::add_section(
	...
	[
		'title'         => esc_html__('Loading', 'automize'),
		'panel'         => RISING_BAMBOO_KIRKI_PANEL_COMPONENT,
		'description'   => esc_html__('This section contains advanced configurations for "Loading ...".', 'automize'),
	]
);
...
RisingBambooKirki::add_field(
	...
	[
		...
		'priority' => $priority++,
		'default'  => '<div class="rising-bamboo-kirki-separator">' . esc_html__('Loading', 'automize') . '</div>',
	]
);
...
RisingBambooKirki::add_field(
	...
	[
		...
		'label'       => esc_html__('Block Loading', 'automize'),
		'section'     => RISING_BAMBOO_KIRKI_SECTION_COMPONENT_LOADING,
...
RisingBambooKirki::add_field(
	...
	[
		...
		'label'       => esc_html__('Button Loading', 'automize'),
		'section'     => RISING_BAMBOO_KIRKI_SECTION_COMPONENT_LOADING,
