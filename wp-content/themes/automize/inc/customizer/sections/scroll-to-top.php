...
RisingBambooKirki::add_section(
	...
	[
		'title'         => esc_html__('Scroll To Top', 'automize'),
		'panel'         => RISING_BAMBOO_KIRKI_PANEL_COMPONENT,
		'description'   => esc_html__('This section contains advanced configurations for "Scroll To Top".', 'automize'),
	]
);
...
RisingBambooKirki::add_field(
	...
	[
		...
		'priority' => $priority++,
		'default'  => '<div class="rising-bamboo-kirki-separator">' . esc_html__('Scroll To Top', 'automize') . '</div>',
	]
);
