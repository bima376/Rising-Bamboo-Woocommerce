...
RisingBambooKirki::add_section(
	...
	[
		'title'         => esc_html__('Rating', 'automize'),
		'panel'         => RISING_BAMBOO_KIRKI_PANEL_COMPONENT,
		'description'   => esc_html__('This section contains advanced configurations for rating.', 'automize'),
	]
);
...
RisingBambooKirki::add_field(
	...
	[
		...
		'priority' => $priority++,
		'default'  => '<div class="rising-bamboo-kirki-separator">' . esc_html__('Rating', 'automize') . '</div>',
	]
);
...
RisingBambooKirki::add_field(
	...
	[
		...
		'description' => esc_html__('Choose the rating icon ?', 'automize'),
		'section'     => RISING_BAMBOO_KIRKI_SECTION_COMPONENT_RATING,
...
RisingBambooKirki::add_field(
	...
	[
		...
		'description' => esc_html__('Unit : rem', 'automize'),
		'section'     => RISING_BAMBOO_KIRKI_SECTION_COMPONENT_RATING,
