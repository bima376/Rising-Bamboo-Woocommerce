...
RisingBambooKirki::add_section(
	...
	[
		'title'         => esc_html__('Mobile Navigation', 'automize'),
		'panel'         => RISING_BAMBOO_KIRKI_PANEL_COMPONENT,
		'description'   => esc_html__('This section contains configurations for Mobile Navigation. Please turn on mobile mode when configuring.', 'automize'),
	]
);
...
RisingBambooKirki::add_field(
	...
	[
		...
		'priority' => $priority++,
		'default'  => '<div class="rising-bamboo-kirki-separator">' . esc_html__('Mobile Navigation', 'automize') . '</div>',
	]
);
...
RisingBambooKirki::add_field(
	...
	[
		...
		'label'           => esc_html__('Text Color', 'automize'),
		'section'         => RISING_BAMBOO_KIRKI_SECTION_COMPONENT_MOBILE_NAVIGATION,
...
RisingBambooKirki::add_field(
	...
	[
		...
		'description'     => esc_html__('Behaviour of mobile navigation when you scroll down/up the page', 'automize'),
		'section'         => RISING_BAMBOO_KIRKI_SECTION_COMPONENT_MOBILE_NAVIGATION,
