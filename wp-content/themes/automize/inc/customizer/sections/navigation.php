...
RisingBambooKirki::add_section(
	...
	[
		'title'         => esc_html__('Post Navigation', 'automize'),
		'panel'         => RISING_BAMBOO_KIRKI_PANEL_BLOG,
		'description'   => esc_html__('This section contains advanced configurations for "Post Navigation".', 'automize'),
	]
);
...
RisingBambooKirki::add_field(
	...
	[
		...
		'priority' => $priority++,
		'default'  => '<div class="rising-bamboo-kirki-separator">' . esc_html__('Post Navigation', 'automize') . '</div>',
	]
);
...
RisingBambooKirki::add_field(
	...
	[
		...
		'label'       => esc_html__('Single Post', 'automize'),
		'description' => esc_html__('Display navigation for single post (or attachment, or custom post type)', 'automize'),
		'section'     => RISING_BAMBOO_KIRKI_SECTION_COMPONENT_POST_NAVIGATION,
...
RisingBambooKirki::add_field(
	...
	[
		...
		'label'       => esc_html__('Page', 'automize'),
		'description' => esc_html__('Display navigation for page', 'automize'),
		'section'     => RISING_BAMBOO_KIRKI_SECTION_COMPONENT_POST_NAVIGATION,
...
RisingBambooKirki::add_field(
	...
	[
		...
		'label'       => esc_html__('Attachment', 'automize'),
		'description' => esc_html__('Display navigation for attachment', 'automize'),
		'section'     => RISING_BAMBOO_KIRKI_SECTION_COMPONENT_POST_NAVIGATION,
...
RisingBambooKirki::add_field(
	...
	[
		...
		'label'       => esc_html__('Other Post Type', 'automize'),
		'description' => esc_html__('Display navigation for other post type', 'automize'),
		'section'     => RISING_BAMBOO_KIRKI_SECTION_COMPONENT_POST_NAVIGATION,
