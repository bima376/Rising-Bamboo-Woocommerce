...
<main id="primary" class="site-main primary-404 overflow-auto" >
	<section class="error-404 not-found">
		<div class="container mx-auto">
			<div class="page-content text-center my-[120px]">
				<div class="image mb-[76px]">
					<?php if ( empty($page_404_image) ) { ?>
						<img class="img-fluid inline max-w-[770px]" src="<?php echo esc_url(RBB_THEME_DIST_URI . 'images/404-Error/404-error-page.png'); ?>" alt="Image 404">
					<?php } else { ?>
