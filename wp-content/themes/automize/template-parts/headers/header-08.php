	...
	<div class="rbb-header-sticky">
			...
			<div class="2xl:container header-content px-[15px] mx-auto md:block hidden overflow-hidden">
				<div class="header-top flex flex-nowrap items-center h-full">
					...
					<div id="rbb-header-top-right" class="rbb-header-right relative h-full ml-3 flex items-center ml-auto mr-0">
						...
						if ( $sidebar_active ) {
							?>
							<div class="policy py-[30px] min-h-10 md:flex hidden items-center text-white">
								<?php
		...
		<div class="header-bottom h-0 md:block hidden">
			<div class="2xl:container px-[15px] mx-auto h-0">
				<div class="lg:w-[285px] w-[65px] relative h-[60px] -top-[60px] vertical-menu pr-[15px] z-[100] <?php echo ( is_home() || is_front_page() ) ? 'active' : 'menu-hidden'; ?>">
					<div class="relative">
						...
						<div id="header-vertical_menu" class="vertical-menu-content absolute top-[100%] left-0 w-full z-10 border border-[#e2e2e2] shadow-[3px_3px_6px_0px_rgba(0,0,0,0.08)] bg-white rounded-b-[10px] lg:block hidden <?php echo ( is_front_page() ) ? 'active' : ''; ?>" >
