		...
		<div class="content container mx-auto pt-[110px] pb-[120px] px-[15px] xl:px-0">
			<div class="rbb-title text-center">
				<h3 class="related_title mb-8 pb-5 text-2xl">
					<span class="uppercase"><?php esc_html_e('Related Posts', 'automize'); ?></span>
				</h3>
			</div>
							...
							<div class="post-info pt-[26px]">
								<div class="blog_meta flex justify-between font-bold text-xs uppercase text-[#cdcdcd]">
									...
									<div class="blog_author">
										...
										<span><?php echo esc_html__('By ', 'automize'); ?><?php echo esc_html__('By ', 'automize'); ?><?php echo get_the_author(); ?></span>
									</div>
								</div>
								<div class="blog_title font-bold text-lg mt-2 block">
									<a class="title !leading-[26px] line-clamp-2" href="<?php esc_url(get_the_permalink($post)); ?>"><?php the_title(); ?></a>
								</div>
								...
								<div class="content-buttom flex justify-between text-xs border-t-[1px] border-[#e5e5e5] mt-6 pt-5">
									<a href="<?php esc_url(get_the_permalink($post)); ?>" class="blog_readmore font-semibold flex items-center">
										<span class="mr-1.5"><?php echo esc_html__('Read more', 'automize'); ?></span>
										<i class="rbb-icon-direction-711 relative top-[2px]"></i>
									</a>
									<span class="pr-7">
										<span class="pl-2"><?php echo esc_html(get_the_time('dS M Y')); ?></span>
									</span>
								</div>
							</div>
						</div>
