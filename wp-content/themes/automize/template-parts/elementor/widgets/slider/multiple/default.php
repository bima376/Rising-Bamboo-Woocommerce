			...
			<div class="block_title text-center flex justify-center items-center">
				...
				<?php if ( $widget_title || $widget_sub_title ) { ?>
					...
					<div class="block_slide">
						<div class="rbb-slick-carousel slick-carousel flex slick-carousel-center item-row grid-rows-1 load-item-<?php echo esc_attr($sliders_to_show_default); ?>" data-slick='{
						...
						foreach ( $sliders as $slider ) {
							...
							<div class="item elementor-repeater-item-<?php echo esc_attr($slider['_id']); ?> basis-0 max-w-full">
								<div class="block__content relative group duration-300 flex items-center justify-center px-5 py-[18px]">
