					...
					<div class="block_slide">
						...
						foreach ( $sliders as $slider ) {
							...
							<div class="item elementor-repeater-item-<?php echo esc_attr($slider['_id']); ?> basis-0 grow max-w-full">
								<div class="block__content relative group duration-300 bg-white flex items-center justify-center min-h-[120px] rounded-[10px] px-5 py-[18px] border border-[#e2e2e2] shadow-[3px_3px_6px_0px_rgba(0,0,0,0.08)]">
									<?php if ( $slider[ $slick->get_name_setting('multiple_content_image') ]['url'] ) { ?>
										<img class="max-w-[120px] max-h-[50px] inline-block group-hover:animate-[hexagonIcon_1s_ease-in-out]" src="<?php echo esc_url($slider[ $slick->get_name_setting('multiple_content_image') ]['url']); ?>" alt="<?php echo esc_attr($slider[ $slick->get_name_setting('multiple_content_title') ]); ?>">
									<?php } ?>
