				...
				<?php if ( $widget_title || $widget_sub_title ) { ?>
					<div class="title_block inline-block mb-8">
						...
						if ( $widget_sub_title ) {
							...
							if ( $widget_title ) {
								?>
								<h4 class="main-title text-2xl"><?php echo esc_html($widget_title); ?></h4> <?php } ?>
							</div>
						<?php } ?>
						<?php if ( 'true' === $show_arrows ) { ?>
							<div class="slick-arrow-custom text-lg text-white">
					...
					<div class="block_slide">
						...
						foreach ( $sliders as $slider ) {
							...
							<div class="item elementor-repeater-item-<?php echo esc_attr($slider['_id']); ?> basis-0 max-w-full mb-5">
								<div class="block__content relative group duration-300 bg-[#f3f3f3] text-center rounded-[10px] px-2 py-[18px]">
									<?php if ( $slider[ $slick->get_name_setting('multiple_content_image') ]['url'] ) { ?>
										<img class="max-w-[128px] max-h-[128px] !inline-block group-hover:animate-[hexagonIcon_1s_ease-in-out]" src="<?php echo esc_url($slider[ $slick->get_name_setting('multiple_content_image') ]['url']); ?>" alt="<?php echo esc_attr($slider[ $slick->get_name_setting('multiple_content_title') ]); ?>">
									<?php } ?>
									<h4 class="pt-1.5 pb-2.5">
										<?php
									...
									<?php if ( ! empty($slider[ $slick->get_name_setting('multiple_content_description') ]) ) { ?>
										<p class="text-center pb-4"><?php echo esc_html($slider[ $slick->get_name_setting('multiple_content_description') ]); ?></p>
									<?php } ?>
