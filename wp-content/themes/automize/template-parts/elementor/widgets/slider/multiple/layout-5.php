			...
			<div class="block_title text-center flex justify-center items-center">
				...
				<?php if ( $widget_title || $widget_sub_title ) { ?>
					...
					<div class="block_slide">
						<div class="rbb-slick-carousel slick-carousel pb-10 flex slick-carousel-center load-item-<?php echo esc_attr($sliders_to_show_default); ?>" data-slick='{
						...
						foreach ( $sliders as $slider ) {
							...
							?>
							<div class="item h-full elementor-repeater-item-<?php echo esc_attr($slider['_id']); ?> mb-5">
								<div class="block__content h-full  relative group duration-300 border border-[#e2e2e2] shadow-[3px_3px_6px_rgba(0,0,0,0.08)] text-center rounded-[10px] px-7 py-[18px]">
									<h5 class="pt-0.5 pb-5">
										<?php
									...
									<?php if ( ! empty($slider[ $slick->get_name_setting('multiple_content_description') ]) ) { ?>
										<p class="text-left mt-5 mb-10"><?php echo esc_html($slider[ $slick->get_name_setting('multiple_content_description') ]); ?></p>
									<?php } ?>
									...
									if ( $button ) {
										...
										class="rbb-slick-button button hover:text-white">
										<span class="rounded-full px-2.5 min-w-[145px] h-[50px] duration-300 inline-flex justify-center items-center bg-[color:var(--rbb-general-button-bg-color)] hover:bg-[color:var(--rbb-general-button-bg-hover-color)]">
