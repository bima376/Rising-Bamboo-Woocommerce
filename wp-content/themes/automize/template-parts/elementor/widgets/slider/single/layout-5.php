								...
								if ( $slider_title || $slider_sub_title || $description || $button_1 || $button_2 ) {
									...
									switch ( $horizontal_align ) {
										...
										case 'center':
											...
											break;
										default:
											$horizontal_align_class = 'md:left-[15px] md:text-left text-left';
									}
									...
									switch ( $vertical_align ) {
										case 'bottom':
											...
											break;
										case 'middle':
											$vertical_align_class = 'top-1/2 -translate-y-1/2';
											break;
										default:
											$vertical_align_class = 'top-1/4';
									}
									?>
									<div class="absolute info-wap lg:w-[42%] md:w-1/2 z-50 <?php echo esc_attr($horizontal_align_class); ?> <?php echo esc_attr($vertical_align_class); ?>">
										<div class="info-inner pr-[15px]">
											<?php
											...
											if ( $description ) {
												...
												<div data-visibility-start="<?php echo esc_attr($description_visibility); ?>"
													...
													class="description md:truncate md:mb-4 lg:whitespace-normal lg:mb-6 max-w-[500px] <?php echo esc_attr($description_visibility); ?>"><?php echo wp_kses_post($description); ?></div>
											<?php } ?>
											<?php
