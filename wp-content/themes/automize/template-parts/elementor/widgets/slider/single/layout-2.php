						...
						<div class="md:absolute md:py-0  top-0 w-full h-full">
							<div class="container <?php echo esc_attr(( $parallax ) ? 'parallax' : ''); ?> m-auto relative h-full">
								...
								if ( $slider_title || $slider_sub_title || $description || $button_1 || $button_2 ) {
									...
									?>
									<div class="absolute info-wap lg:w-[42%] md:w-1/2 w-3/4 z-50 <?php echo esc_attr($horizontal_align_class); ?> <?php echo esc_attr($vertical_align_class); ?>">
										<div class="info-inner">
											...
											if ( $description ) {
												...
												<div data-visibility-start="<?php echo esc_attr($description_visibility); ?>"
													...
													class="description md:truncate md:mb-4 lg:whitespace-normal lg:mb-6 <?php echo esc_attr($description_visibility); ?>"><?php echo wp_kses_post($description); ?></div>
											<?php } ?>
											<?php
											$horizontal_align_center = $slider[ $slick->get_name_setting('horizontal_align') ] ?? 'center';

											?>
											<div class="button-group flex justify-left items-center text-left <?php echo ( 'center' !== $horizontal_align_center ) ? 'md:justify-start' : 'justify-center'; ?>">
												<?php
												if ( $button_1 ) {
