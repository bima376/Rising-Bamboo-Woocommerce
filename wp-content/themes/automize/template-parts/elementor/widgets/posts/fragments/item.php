...
<div class="item">
	<div class="blog_item group">
		<div class="blog_image rounded-[10px] overflow-hidden mb-[26px]">
			<a href="<?php echo esc_url(get_permalink($_post)); ?>" class="w-full">
				...
				if ( has_post_thumbnail($_post) ) {
					...
					?>
					<img class="w-full duration-300 scale-100 group-hover:scale-105"
		...
		<div class="blog_info mb-[23px]">
			...
			<a href="<?php echo esc_url(get_permalink($_post)); ?>" class="blog_title text-lg mt-2 block font-bold">
				<span class="line-clamp-2"><?php echo esc_html(get_the_title($_post)); ?></span>
			</a>
			<div class="content line-clamp-2 pt-4">
				<?php echo esc_html(wp_trim_words(get_the_content(null, false, $_post->ID), 30, '...')); ?>
			</div>
