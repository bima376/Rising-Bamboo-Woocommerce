...
if ( count($data['products']) ) {
	...
	<div id="<?php echo esc_attr($id); ?>" class="rbb_woo_products <?php echo esc_attr($layout); ?>">
		...
		<?php } ?>
		<div class="2xl:container mx-auto pb-10">
			<div class="pb-5">
				<div class="title_left text-center">
					<?php if ( $show_title ) { ?>
					<div class="border-title mb-4">
						<h2 class="title uppercase text-2xl font-bold"><?php echo wp_kses_post($data['title']); ?></h2>
			...
			>
				...
				foreach ( $data['products'] as $product ) {
					View::instance()->load(
						'elementor/widgets/woo-products/fragments/item-5',
						[
							'product' => $product,
						]
					);
