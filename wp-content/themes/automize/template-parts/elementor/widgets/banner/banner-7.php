		...
		<div class="lg:mb-0 mb-[30px] mx-auto md:max-w-[460px] absolute left-0 z-10 text-left top-[50%] -translate-y-1/2 lg:px-10 px-[15px]">
			<div class="text-white">
				<div class="title_block">
					...
					<h5 class="sub_title text-base"><?php echo wp_kses_post($sub_title); ?></h5>
				</div>
				...
				foreach ( $buttons as $button ) {
					...
					<a <?php echo ( 'url' !== $button_type ) ? 'onclick="RisingBambooModal.modal(\'#rbb-modal-button-' . esc_attr($button['_id']) . '\', event)"' : ''; ?>
						...
						<?php echo ! empty($button_url_nofollow) ? 'rel="' . esc_attr($button_url_nofollow) . '"' : ''; ?>
							class="inline-block btn text-center pl-6 pr-[7px] rbb-button relative <?php echo esc_attr($button_position); ?> <?php echo esc_attr($button_class); ?>"
						<?php
						...
						<?php if ( $button_icon_status && 'before' === $button_icon_position ) { ?>
							<span class="button-icon mr-2 inline-block align-middle">
									...
									if ( ! empty($button_icon['value']) ) {
										...
										?>
										<i class="rbb-icon-direction-711 inline-block" aria-hidden="true"></i>
									<?php } ?>
								</span>
						<?php } ?>
						...
						<?php if ( $button_icon_status && 'after' === $button_icon_position ) { ?>
								<span class="button-text">
									...
									if ( ! empty($button_icon['value']) ) {
										...
										?>
										<i class="rbb-icon-direction-711 pl-2 text-xl align-sub inline-block" aria-hidden="true"></i>
									<?php } ?>
								</span>
						<?php } ?>
						</a>
