			...
			<div class="px-5">
				<div class="text-center">
					<div class="title_block">
						<h4 class="title text-2xl mb-3"><?php echo wp_kses_post($title); ?></h4>
						<p class="sub_title text-xs mb-2.5"><?php echo wp_kses_post($sub_title); ?></p>				
					</div>
					<div class="desc text-white mt-2"><?php echo wp_kses_post($description); ?></div>
				</div>
				<?php
				...
				<div class="flex items-center justify-center mt-6">
					...
					foreach ( $buttons as $button ) {
						...
						class="inline-block btn h-[50px] leading-[50px] pl-6 pr-[7px] rounded-[50px] rbb-button <?php echo esc_attr($button_position); ?> <?php echo esc_attr($button_class); ?>"
						<?php
			...
			<div class="relative text-center">
				...
				foreach ( $images as $image ) {
					...
					<div class="banner-img">
						...
						<?php } ?>
						<img alt="Image" src="<?php echo esc_url($image[ $widget->get_name_setting('image') ]['url']); ?>" class="w-full scale-100 hover:scale-105 <?php echo esc_attr(( $parallax ) ? 'layer' : ''); ?> inline-block <?php echo esc_attr($css_class); ?> <?php echo esc_attr($position); ?> <?php echo esc_attr($repeater_image_class); ?>"
						<?php if ( $parallax ) { ?>
