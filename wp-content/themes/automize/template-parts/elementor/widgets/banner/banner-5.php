...
<div id="<?php echo esc_attr($id); ?>" class="relative group overflow-hidden rounded-[10px] <?php echo esc_attr($layout); ?>">
	<div class="lg:grid relative">
		<div class="lg:mb-0 mb-[30px] mx-auto md:max-w-[460px] absolute left-0 z-10 text-left top-[50%] -translate-y-1/2 lg:px-[30px] px-[15px]">
			...
			?>
			<div class="flex items-left justify-left mt-[18px]">
				<?php
					...
					>
						...
						<?php if ( $button_icon_status && 'after' === $button_icon_position ) { ?>
									...
									if ( ! empty($button_icon['value']) ) {
										...
										?>
										<i class="rbb-icon-direction-711 pl-2 text-xl inline-block align-sub group-hover:animate-[hexagonIcon_1s_linear_infinite]" aria-hidden="true"></i>
									<?php } ?>
						<?php } ?>
						</span>
					</a>
		...
		<div class="col-span-12 lg:col-span-12">
			<div class="<?php echo esc_attr(( $parallax ) ? 'parallax' : ''); ?> relative text-center">
				...
				foreach ( $images as $image ) {
					...
					?>
					<?php if ( 0 === $img_count ) { ?>
						<div class="banner-img group-hover:scale-105 duration-300">
							<?php
