...
<div id="<?php echo esc_attr($id); ?>" class="banner-image group relative overflow-hidden <?php echo esc_attr($layout); ?>">
	<div class="mx-auto text-center">
		<div class="md:grid relative overflow-hidden rounded-[10px]">
			<div class="absolute left-0 w-full z-10 text-left md:top-[50px] top-10 px-5">
				<div class="text-center">
					<div class="title_block">
						<h4 class="title text-lg"><?php echo wp_kses_post($title); ?></h4>
						<p class="sub_title text-base text-white mb-2"><?php echo wp_kses_post($sub_title); ?></p>
					</div>
					<div class="desc font-semibold text-xs leading-[22px] mt-2 text-[color:var(--rbb-general-heading-color)]"><?php echo wp_kses_post($description); ?></div>
				</div>
				<?php
			...
			<div class="relative text-center">
				...
				foreach ( $images as $image ) {
					...
					<div class="banner-img">
						...
						<?php } ?>
						<img alt="Image" src="<?php echo esc_url($image[ $widget->get_name_setting('image') ]['url']); ?>" class="w-full scale-100 group-hover:scale-105 duration-300 <?php echo esc_attr(( $parallax ) ? 'layer' : ''); ?> inline-block <?php echo esc_attr($css_class); ?> <?php echo esc_attr($position); ?> <?php echo esc_attr($repeater_image_class); ?>"
						<?php if ( $parallax ) { ?>
