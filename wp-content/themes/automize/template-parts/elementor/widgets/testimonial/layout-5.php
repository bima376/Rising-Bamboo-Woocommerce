...
if ( $testimonials ) {
	...
	<div class="rbb-testimonial relative <?php echo esc_attr($layout); ?>">
		...
		<div class="pb-2.5">
			...
			<div class="overflow-hidden max-w-[900px] m-auto">
				...
				foreach ( $testimonials as $testimonial ) {
					...
					<div class="item item-<?php echo esc_attr($testimonial->ID); ?> text-center">
						<div class="testimonial_ratings flex justify-center text-base mt-[34px] mb-[14px] text-[#ffe200]">
						...
						<div class="testimonial_text mb-8 line-clamp-[7] relative !text-white"><?php echo wp_kses_post($testimonial->post_content); ?></div>
						<div class="block_content-name flex items-center justify-center mb-[30px]">
							<h5 class="testimonial_info text-xs mr-1 text-[color:var(--rbb-general-secondary-color)]">
								<?php echo esc_html($testimonial->post_title); ?>
							</h5>
							<h6 class="testimonial_excerpt text-xs !text-white">-  <?php echo wp_kses_post($testimonial->post_excerpt); ?></h6>
						</div>
