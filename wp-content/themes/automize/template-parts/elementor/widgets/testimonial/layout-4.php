...
if ( $testimonials ) {
	...
	<div class="rbb-testimonial relative <?php echo esc_attr($layout); ?>">
		...
		<div class="pb-2.5">
			...
			<?php endif; ?>
			<div class="bg-[#070d12] rounded-[10px] border border-[#FFFFFF1A] px-[30px] pt-[30px] pb-[60px] rounded-[10px] overflow-hidden">
				...
				foreach ( $testimonials as $testimonial ) {
					...
					<div class="item item-<?php echo esc_attr($testimonial->ID); ?> text-center">
						...
						<div class="block_content-name flex items-center justify-center mb-[30px]">
							<h5 class="testimonial_info text-xs mr-1 text-white">
