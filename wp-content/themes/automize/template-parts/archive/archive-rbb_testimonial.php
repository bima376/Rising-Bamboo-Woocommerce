		...
		<div class="pagetestimonial md:flex bg-[#f1f1f1] py-11 px-4 rounded-[20px] my-[30px] text-center md:text-left">
			...
			<div class="w-[100%] md:w-[60%] lg:w-[79%] flex items-center">
				<div class="content relative pl-[35px] md:pl-[70px]">
					<span
						class="font-medium uppercase tracking-[2px] leading-10"><?php echo esc_html__("what's happy customers say", 'automize'); ?></span>
					<div
						class="text-[color:var(--rbb-title-color)] text-[1.5rem] font-bold max-w-[450px] leading-10"><?php echo esc_html__('See Why Thousands of Customer Love Us!', 'automize'); ?></div>
				</div>
			</div>
		</div>
