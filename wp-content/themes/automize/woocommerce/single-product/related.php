...
if ( $related_products ) : ?>
	...
	<section class="related rbb_woo_products relative <?php echo esc_attr(( 'list' === $tabsproduct ) ? ' pb-[85px]' : ''); ?>">
		<?php if ( 'tabs' !== $tabsproduct ) { ?>
		<div class="rbb-title -mb-9 mt-[108px]">
			<div class="text-[30px] font-extrabold"><?php echo esc_html__('Related Products', 'automize'); ?></div>
		</div>
		<?php } ?>
