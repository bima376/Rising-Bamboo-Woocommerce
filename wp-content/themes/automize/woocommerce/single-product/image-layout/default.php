...
<div class="rbb-product-single-image-default sticky top-24 col-span-1 <?php echo esc_attr(implode(' ', array_map('sanitize_html_class', $args['wrapper_classes']))); ?>">
	<div class="product-single__sticky xl:overflow-hidden <?php echo esc_attr(( 'bottom' !== $thumbnail_position ) ? 'xl:flex' : ''); ?> <?php echo esc_attr(( 'left' === $thumbnail_position ) ? 'flex-row-reverse' : ''); ?> <?php echo esc_attr(( 'top' === $thumbnail_position ) ? 'flex-col-reverse' : ''); ?>">
		...
		<div class="rbb-product-thumbs -mx-[7px]
			<?php echo esc_attr(( 'left' === $thumbnail_position ) ? 'flex-none xl:w-[107px] xl:-my-2 xl:mr-[15px] xl:mx-0 xl:pt-0 pt-2' : ''); ?>
			<?php echo esc_attr(( 'right' === $thumbnail_position ) ? 'flex-none xl:w-[107px] xl:-my-[7px] xl:ml-[15px] xl:mx-0 xl:pt-0 pt-[15px]' : ''); ?>
			<?php echo esc_attr(( 'top' === $thumbnail_position ) ? 'xl:pb-[10px] pb-0 xl:pt-0 pt-[15px]' : ''); ?>
			<?php echo esc_attr(( 'bottom' === $thumbnail_position ) ? 'pt-[15px]' : ''); ?>
		">
			<div class="rbb-slick-product-thumb <?php echo esc_attr(( 'top' === $thumbnail_position || 'bottom' === $thumbnail_position ) ? 'flex items_2' : ''); ?>" data-slick='{
				"dots": false,
				"nav": false,
				"slidesToShow": <?php echo esc_attr($thumbnail_number); ?>,
				"fade": false,
				"vertical" : <?php echo esc_attr(( 'left' === $thumbnail_position || 'right' === $thumbnail_position ) ? 'true' : 'false'); ?>,
				"verticalSwiping":<?php echo esc_attr(( 'left' === $thumbnail_position || 'right' === $thumbnail_position ) ? 'true' : 'false'); ?>,
				"infinite": true,
				"useTransform": false,
				"speed": 500,
				"cssEase": "cubic-bezier(0.77, 0, 0.18, 1)",
