...
if ( ! empty($product_tabs) ) : ?>
	...
	<div class="woocommerce-tabs wc-tabs-wrapper flow-root lg:pt-[120px] pt-[60px]">
		<ul class="tabs title_heading overflow-x-auto md:overflow-x-visible wc-tabs flex whitespace-nowrap m-0 p-0 <?php echo esc_attr(( 'slider' === $layout_product ) ? 'md:justify-center' : ''); ?>" role="tablist">
			<?php foreach ( $product_tabs as $key => $product_tab ) : ?>
				<li class="<?php echo esc_attr($key); ?>_tab" id="tab-title-<?php echo esc_attr($key); ?>" role="tab" aria-controls="tab-<?php echo esc_attr($key); ?>">
					<a class="block relative py-[15px] px-[31px]" href="#tab-<?php echo esc_attr($key); ?>">
