...
if ( $upsells ) : ?>
	...
	<section class="up-sells upsells products rbb_woo_products relative <?php echo esc_attr(( 'tabs' !== $tabsproduct ) ? 'pb-[85px]' : ''); ?>">
		<?php
		if ( 'tabs' !== $tabsproduct ) {
			$heading = apply_filters('woocommerce_product_upsells_products_heading', __('Recommended', 'automize'));
			if ( $heading ) :
				?>
		...
		?>
			<div class="content_right xl:pl-[15px] xl:-ml-[15px] slider_content overflow-hidden pt-20">
