...
?>
<div id="_desktop_cart" class="rbb-mini-cart relative flex items-center justify-center" data-text_added="<?php echo esc_attr__('Product was added to cart successfully!', 'automize'); ?>">
	<div class="dropdown">
		...
		<div class="mini-cart-content z-10 absolute top-full xl:-right-[30px] right-0 opacity-0 invisible dropdown-menu transition-all duration-300 transform origin-top-right">
			<div class="pt-5 overflow-hidden min-w-[332px] bg-[color:var(--rbb-mini-cart-content-background-color)] rounded-[18px] origin-top-right outline-none shadow-[5px_6px_15px_0px_rgba(0,0,0,0.15)]" id="mini-cart-content-control" role="menu">
			...
			<div class="<?php echo esc_attr($class_string); ?>">
				<div class="cart-right md:w-[370px] w-4/5 fixed top-0 -right-[370px] bottom-0 bg-white z-30 shadow-[-10px_0_15px_0_rgba(0,0,0,0.1)]">
					<div class="title-cart title relative items-center flex px-5 pt-[14px] pb-3 mb-5">
						...
						<span class="pl-4 text-sm title uppercase"><?php echo esc_html__('Shopping Cart', 'automize'); ?></span>
					</div>
					<?php echo wp_kses_post(RisingBambooWoocommerce::mini_cart_content()); ?>
				</div>
			</div>
