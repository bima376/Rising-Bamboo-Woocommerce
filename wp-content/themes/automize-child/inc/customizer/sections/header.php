<?php
/**
 * The header section - Child Theme Override
 *
...
// Debug: Log bahwa child theme customizer dijalankan
error_log('CHILD THEME CUSTOMIZER HEADER: Child theme customizer is running!');
...
// Debug: Log paths
error_log('CHILD THEME CUSTOMIZER HEADER: Child path: ' . $child_headers_path);
error_log('CHILD THEME CUSTOMIZER HEADER: Parent path: ' . $parent_headers_path);
...
if (is_dir($child_headers_path) && count(glob($child_headers_path . '*.php')) > 0) {
    ...
    error_log('CHILD THEME CUSTOMIZER HEADER: Using child theme files: ' . print_r($headers, true));
} else {
    ...
    error_log('CHILD THEME CUSTOMIZER HEADER: Using parent theme files: ' . print_r($headers, true));
}
