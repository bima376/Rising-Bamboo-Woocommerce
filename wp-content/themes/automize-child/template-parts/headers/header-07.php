...
?>
<header id="rbb-default-header" class="rbb-default-header header-7 md:absolute z-20 w-full bg-[color:var(--rbb-header-background-color)]">
	<div class="rbb-header-sticky">
		<div class="header-inner relative mx-auto h-full">
			<div class="container header-top mx-auto h-full md:block hidden">
				<div class="flex flex-nowrap items-center justify-between md:h-[90px] h-[60px]">
					<div class="vertical-menu relative z-50">
						<div class="vertical-menu-title cursor-pointer duration-300 2xl:mr-0 mr-5 lg:block hidden">
							<i class="rbb-icon-menu-6 text-[26px] text-[color:var(--rbb-general-secondary-color)]"></i>
						</div>
					...
					<?php if ( Helper::show_search_product_form() && false === Setting::get(RISING_BAMBOO_KIRKI_FIELD_COMPONENT_SEARCH_OVERLAY) ) { ?>
						<div id="_desktop_search" class="flex-auto items-center justify-center max-w-[940px] px-5">
				...
				<div class="container mx-auto h-full md:block hidden">
					<div class="rbb-header-center flex justify-center">
